<template>
  ...
  <h1 style="margin-left: 10px; color: #194759">
    Welcome to BookMe's Learning Avenue
  </h1>
  <p style="margin-left: 10px; color: #4f7369">
  ...
  <div class="container">
    <div class="row me-auto">
      <div class="col-md-5 col-12 mb-5">
        ...
        <p>
          ...
          perspiciatis quos nulla commodi labore cum atque quas, voluptas
          quisquam error eaque tempore nam natus, saepe quidem velit fuga.
          Numquam, distinctio? <br /><br />Lorem ipsum dolor, sit amet
          consectetur adipisicing elit. Laudantium voluptatem non enim
          perspiciatis harum nisi porro ea ducimus repudiandae, maxime
          distinctio hic libero nemo atque. Eos ducimus fugiat nam id!
        </p>
    ...
    <h1 style="margin-left: 10px;color:#194759">Welcome to BookMe's Learning Avenue</h1>
    <p style="margin-left: 10px;color: #4F7369">Have a look at all the courses BookMe has to offer you to guide you in your entrepreneural journey!</p>
    <br>
    ...
    <div class="container">
        <div class="row me-auto">
            ...
            <div class="col-md-6 col-12 mb-5" style="text-align: center;">
                <iframe width="100%" height="370"  src="https://www.youtube.com/embed/f-jopUTj5_Y?si=zv-YHGww3wjAbCmJ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe> 
            </div>
            </div>

            <div class="row me-auto">
                <div class="col-md-6 col-12 mb-5" style="text-align: center;">
                    <iframe width="100%" height="370" src="https://www.youtube.com/embed/r1mwj8AH98Y?si=um3vCewP7_XPBNgi" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                </div>
...
Through practical exercises and expert instruction, you'll gain hands-on experience navigating the Google Analytics platform. Whether you're a business owner, marketer, or a newcomer to data analysis, this course will equip you with the essential skills to make informed, data-driven decisions and optimize your online presence. Join us on this beginner-friendly journey to demystify the world of web analytics with Google Analytics.</p>
            ...
            <div class="col-md-6 col-12 mb-5" style="text-align: center;">
                <iframe width="100%" height="370" src="https://www.youtube.com/embed/njri8_gJTs0?si=Yv1_Ua8JcptuivG1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
            </div>

            <div class="row me-auto">
                <div class="col-md-6 col-12 mb-5" style="text-align: center;">
                    <iframe width="100%" height="370" src="https://www.youtube.com/embed/Wzwpou8d7v4?si=sddhMuRXJGkilDoy" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                </div>
    ...
    <div class="row me-auto">
      <div class="col-md-5 col-12 mb-5">
        ...
        <p>
          ...
          nostrum voluptatem molestiae consequuntur sequi laborum ipsa tenetur
          cum excepturi iste. Magnam placeat nesciunt iure suscipit facere totam
          laudantium qui vero? <br /><br />Lorem ipsum dolor sit, amet
          consectetur adipisicing elit. Soluta perspiciatis quos nulla commodi
          labore cum atque quas, voluptas quisquam error eaque tempore nam
          natus, saepe quidem velit fuga. Numquam, distinctio?
        </p>
        <button type="button" class="btn btn-success" style="color: white">
          Finish Course
        </button>
    ...
    <div class="row me-auto">
      ...
      <div class="col-md-5 col-12 mb-5">
        ...
        <p>
          ...
          dolorem, iusto nisi ullam fuga et, veritatis fugit illo consequuntur
          aliquam deserunt deleniti vero quis! Maiores architecto sint
          doloremque non consectetur! <br /><br />Lorem ipsum dolor sit, amet
          consectetur adipisicing elit. Soluta perspiciatis quos nulla commodi
          labore cum atque quas, voluptas quisquam error eaque tempore nam
          natus, saepe quidem velit fuga. Numquam, distinctio?
        </p>
    ...
    <div class="row me-auto">
      <div class="col-md-5 col-12 mb-5">
        ...
        <p>
          ...
          dicta ullam accusamus amet eligendi qui nulla magnam vel explicabo
          alias dolores, nam in inventore temporibus aliquid neque voluptates
          fugiat? <br /><br />Lorem ipsum dolor sit, amet consectetur
          adipisicing elit. Soluta perspiciatis quos nulla commodi labore cum
          atque quas, voluptas quisquam error eaque tempore nam natus, saepe
          quidem velit fuga. Numquam, distinctio?
        </p>
        <button type="button" class="btn btn-success" style="color: white">
          Finish Course
        </button>
