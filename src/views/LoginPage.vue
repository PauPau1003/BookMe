      ...
      <div class="forms-container">
        <div class="signin-signup">
          <form class="sign-in-form" @submit.prevent="login">
            <img src="/BookMeLogo-removebg-preview.png" alt="Logo" style="height: 80px;">
      ...
      <div class="panels-container">
        <div class="panel left-panel">
          <div class="content">
            ...
            <ul class="features-list"> <!-- Added unordered list for features -->
              <li>Singapore #1 Service Provider</li> <!-- Replaced "projects" with "categories" -->
              <li>Pay per project, not per hour</li>
              <li>Access to local services across Singapore</li>
            </ul>
            
            <button class="btn transparent" id="sign-up-btn" @click="toggleSignUpMode">Sign up</button>
          </div>
          <!-- <img src="../assets/Images/Tirsa/shoecleaner22.jpg" class="image" alt="" /> -->
        </div>
        <div class="panel right-panel">
          <div class="content">
            <h3>Want to be part of BookMe ?</h3>
            <p>
              BookMe #1 for Singapore Service Provider
            </p>
            <button class="btn transparent" id="sign-in-btn" @click="toggleSignUpMode">Sign in</button>
          </div>
          <!-- <img src="../assets/Images/Tirsa/photo3.jpg" class="image" alt="" /> -->
        </div>
    </div>
</div>    
  </template>
...
export default {
  ...
  * {
  ...
  .container:before {
    ...
    background-image: linear-gradient(-45deg, rgb(3, 83, 67) 0%, #04befe 100%);
