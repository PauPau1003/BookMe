  ...
  >
    <div class="row">
      <div
        ...
        style="background-color: #4f7369; min-height: 100vh"
      >
        <div class="container-fluid">
          ...
          <div class="row mb-5">
            <div class="col-12 d-flex justify-content-center">
              <div
                class="card mx=auto"
                style="width: 400px; margin-top: 150px; height: 460px"
              >
                <img
                ...
                <div class="card-body">
                  ...
                  <div v-for="courses in data_array.Courses">
                    <p class="card-text" style="font-weight: bold">
                      <img
                        :src="'../../src/assets/Images/Zan/' + courses.cimg"
                        style="
                          height: 30px;
                          width: 30px;
                          margin: 5px;
...
export default {
  ...
  computed: {
    ...
    averageRating() {
      ...
      const totalRating = this.data_array.reviews.reduce(
        (sum, review) => sum + review.rating,
        0
      );
      this.averageRating = (
        totalRating / this.data_array.reviews.length
      ).toFixed(1);
