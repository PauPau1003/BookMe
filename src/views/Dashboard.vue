<template>
  ...
  >
    ...
    <div class="row mb-3 mx-md-5">
      ...
      <div
        class="col-md-3 col-12 mx-md-5 mb-3"
        data-aos="fade-up"
        data-aos-delay="500"
        style="
          border: 2px solid white;
      ...
      <div
        class="col-md-2 col-12 mx-md-5 mb-3"
        data-aos="fade-up"
        data-aos-delay="400"
        style="
          border: 2px solid white;
    ...
    <div class="row mb-3 mx-2">
      <div
        class="col-md-6 col-12 mx-md-5 mb-3"
        data-aos="fade-up"
        data-aos-delay="400"
        style="
          border: 2px solid white;
      ...
      >
        <div>
          <h3 class="mb-3 plotly-div">Business Summary (This Month)</h3>
          <div id="myBarChart" style="width: 100%"></div>
        </div>
      </div>
      <div
        class="col-md-5 col-12 mx-md-5 mb-3"
        data-aos="fade-up"
        data-aos-delay="400"
        style="
          border: 2px solid white;
      ...
      >
        <div>
          <h3 class="mb-3">MRR</h3>
          <div class="plotly-div" id="myLineChart" style="width: 100%"></div>
        </div>
      </div>
    </div>
  </div>
