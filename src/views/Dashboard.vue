...
<div class="spnavbar">
		...
		<div class="container-fluid" style="background-color:#4F7369 ;border-radius: 5px;padding-bottom:10px;">
			<div class="row mb-4">
				...
				<div class="row mb-3 mx-md-5">
					...
					<div class="col-md-3 col-12 mx-md-5 mb-3"  data-aos="fade-up" data-aos-delay="500" style="border: 2px solid white; border-radius:5px;background-color: white; ">
					...
					<div class="col-md-2 col-12 mx-md-5 mb-3"  data-aos="fade-up" data-aos-delay="400" style="border: 2px solid white; border-radius:5px;background-color: white; ">
					...
					<div class="col-md-2 col-12 mx-md-5 mb-3"  data-aos="fade-up" data-aos-delay="600" style="border: 2px solid white; border-radius:5px;background-color: white; ">
				...
				<div class="row mb-3 mx-2">
					<div class="col-md-6 col-12 mx-md-5 mb-3"  data-aos="fade-up" data-aos-delay="400" style="border: 2px solid white; border-radius:5px;background-color: white; ">
						<div>
						<h3 class="mb-3">Business Summary (This Month)</h3>
						<div id="myBarChart" style="width:100%;"></div>
						</div>
					</div>
					<div class="col-md-5 col-12 mx-md-5 mb-3"  data-aos="fade-up" data-aos-delay="400" style="border: 2px solid white; border-radius:5px;background-color: white; ">
						<div>
						<h3 class="mb-3">MRR</h3>
						<div id="myLineChart" style="width:100%;"></div>
					</div>
					</div>
				</div>
			</div>
  ...
  <div
    ...
    style="background-color: #4f7369; border-radius: 5px; padding-bottom: 10px"
  >
    <div class="row mb-4">
      <div class="col-md-6 col-12">
        <h2 class="font-weight-bold heading mt-5" style="color: white">
    ...
    <div class="row mb-3 mx-2">
      <div
        class="col-md-3 col-12 mx-md-3 mb-3"
        data-aos="fade-up"
        data-aos-delay="300"
        style="
          height: 80%;
      ...
      >
        <p>
          <small class="text-muted">Auto date range</small><br /><img
            src="../../src/assets/Images/Zan/calendar.png"
      ...
      <div
        class="col-md-2 col-12 mx-md-3 mb-3"
        data-aos="fade-up"
        data-aos-delay="300"
        style="
          height: 90%;
    ...
    <div class="row mb-3 mx-2">
      <div
        class="col-md-3 col-5 mx-md-3 mx-3 mb-3"
        data-aos="fade-up"
        data-aos-delay="300"
        style="
          border: 2px solid white;
      ...
      >
        ...
        <div style="text-align: center">
          <h1>${{ totalProductPrice }}</h1>
          <h2 :class="salesChangeClass" style="font-weight: 200">
      ...
      <div
        class="col-md-3 col-5 mx-md-2 mx-3 mb-3"
        data-aos="fade-up"
        data-aos-delay="500"
        style="
          border: 2px solid white;
      ...
      >
        ...
        <div style="text-align: center">
          <h1>{{ salesPercentageChange }}%</h1>
          <h2 :class="businessGrowthClass" style="font-weight: 200">
            {{ businessGrowthChange }}%
          </h2>
          <p style="font-weight: 100">vs previous month</p>
        </div>
      </div>
      ...
      >
        ...
        <div style="text-align: center">
          <h1>${{ totalMRR }}</h1>
          <h2 :class="mrrChangeClass" style="font-weight: 200">
            {{ mrrPercentageChange }}%
          </h2>
          <p style="font-weight: 100">vs previous month</p>
        </div>
      ...
      <div
        class="col-md-2 col-5 mx-md-2 mx-3 mb-3"
        data-aos="fade-up"
        data-aos-delay="600"
        style="
          border: 2px solid white;
    ...
    <div class="row mb-3 mx-2">
      <div
        class="col-md-6 col-12 mx-md-3 mb-3"
        data-aos="fade-up"
        data-aos-delay="400"
        style="
          border: 2px solid white;
      ...
      <div
        class="col-md-5 col-12 mx-md-2 mb-3"
        data-aos="fade-up"
        data-aos-delay="400"
        style="
          border: 2px solid white;
    ...
    async fetchData() {
      ...
      querySnapshot.forEach((doc) => {
        if (doc.data().email == this.email) {
          ...
          const augustMRR = mrrEntries.find(
            (entry) => entry[0] === "August 2023"
          );
          ...
          if (augustMRR && julyMRR) {
            ...
            const percentageChange = ((difference / julyValue) * 100).toFixed(
              2
            ); // You can round to 2 decimal places
          ...
          this.businessGrowthChange = (
            (businessGrowth / prevBusinessGrowth) *
            100
          ).toFixed(2);
        }
      });
