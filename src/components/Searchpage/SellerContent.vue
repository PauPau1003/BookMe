  ...
  <div class="container-fluid">
    <div class="content m-3">
      <div style="text-align: center; margin: 15px; margin-bottom: 30px">
        ...
        <p class="ms-5">
          Discover sellers with a great track record at guiding new buyers.
        </p>
      </div>
      <div class="section" style="background: color #4f7369">
        <div class="container">
          <div class="row">
            <div
              class="col-xs-12 col-lg-4 col-md-6 col-sm-12"
              data-aos="fade-up"
              data-aos-delay="300"
              v-for="service in services"
            >
              <div class="box-feature mb-4" style="height: 570px">
                <div class="text-center">
                  <img
                    :src="
                      '/src/assets/Images/Tirsa/' +
                      service.serviceList.serviceImage[0]
                    "
                    class="cropped-image"
                  />
                  <span class="flaticon-house mb-3 d-block"></span>
                  <!-- <img src="person_1-min.jpg" alt="Image" class="img-fluid rounded-circle w-25 mb-4"> -->
                  <h3 class="mb-2" style="color: black; font-size: 20px">
                    {{ service.name }}
                  </h3>
                  <p class="text-black fw-normal" style="font-size: 15px">
                    {{ service.serviceList.serviceCategory }}
                  </p>
                  <p class="text-black fw-normal">
                    {{ service.serviceList.serviceDescription }}
                  </p>

                  <p class="text-black">
                    From SGD {{ service.serviceList.productArray[0].pricing }}
                  </p>
